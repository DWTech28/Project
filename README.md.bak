...
```powershell
PS C:\> Get-StockPrice -Symbol BTC-USD -Range 1y
```
```console
...
```powershell
PS C:\> Get-StockPrice -Symbol SPY -Interval 5m -Range 1mo
```
```console
...
```powershell
PS C:\> Get-StockPrice -Symbol AAPL -Interval 2m -FromDate -10
```
```console
...
```powershell
PS C:\> Get-StockPrice -Symbol AAPL -Interval 1m -Range 1d | ft
```
```console
